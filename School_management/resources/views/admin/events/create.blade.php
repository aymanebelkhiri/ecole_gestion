    ...
    <div class="sidebar pe-4 pb-3 col-md-6 col-lg-6 col-sm-12">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="{{route('events.index')}}" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Events</a>
                ...
                <div class="table-responsive row ">
                  <form action="{{ route('events.store') }}" method='POST' class="row">
                    ...
                    <div class="mb-3 col-12">
                      ...
                      <textarea name="Description" id="Description" cols="30" rows="7" class="bg-dark form-control"></textarea>
                    </div>
                    <center>

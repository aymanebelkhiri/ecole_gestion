            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive row ">
                     <form action="{{ route('groupes.update',$Groupe->id_groupe) }}" method='POST' class="row">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                           <label for="Effectif" class="form-label">Effective </label>
                        ...
                        <select  class="form-control bg-dark" id="S" name='filiére' value='{{$Groupe->Filiére}}'>
                            @isset($Filiéres)

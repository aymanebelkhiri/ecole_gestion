        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('filiéres.index')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Branchs</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    @endif
                    <a href="{{ route('filiéres.create') }}" class='btn btn-primary col-6'> Add New Branch</a><br><br>
                    <div class="table-responsive row ">
                        <table class='table table-striped'>
                            ...
                            <tr class="text-white">
                                ...
                                <td >{{$Filiére->Domaine}}</td>
                                <td >
                                    <div class="d-flex m-auto" style="width: 150px ; column-gap: 20px">
                                        <a href="{{ route('filiéres.edit', $Filiére->id) }}" class='btn btn-primary'>Edit</a>   

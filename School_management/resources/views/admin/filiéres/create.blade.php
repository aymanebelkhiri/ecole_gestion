            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive row ">
                        <form action="{{ route('filiéres.store') }}" method="POST" enctype="multipart/form-data" class="row">
                            @csrf
                            ...
                            <div class="mb-3 col-md-6 col-lg-6 col-sm-12">
                                ...
                                <input type="file" class="form-control bg-dark" id="Picture" name='img'>
                            </div>
                            <center>
                                <br>
                                <button type="submit" class="btn btn-primary col-4">Add</button><br><br>
                            </center>
                            </form>

        ...
        <div class="sidebar pe-4 pb-3 col-md-6 col-lg-6 col-sm-12">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('modules.index')}}" class="nav-item nav-link active" ><i class="fa fa-laptop me-2"></i>Module</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    @endif
                    <a href="{{ route('modules.create') }}" class='btn btn-primary col-6'> Add New Module</a><br><br>
                    <div class="table-responsive row ">
                        <table class='table table-striped'>
                            <tr>
                                <th scope='col'>Name </th>
                                <th scope='col'>Hourly mass</th>
                            ...
                            <tr>
                                <td class="text-white">{{$Module->Nom}}</td>
                                <td class="text-white">{{$Module->MasseHoraire}}</td>
                                <td class="text-white">{{$Module->Coefficient}}</td>
                                @php
                
                                    $filiere=Filiére::findOrFail($Module->Filiére);
                                @endphp
                                <td class="text-white">{{$filiere->Nom}}</td>
                                <td class="text-white">
                                    <div  style="display: flex; width: 170px; column-gap: 10px;" class="container m-auto">

                                        <a href="{{ route('modules.edit', $Module->id_module) }}" class='btn btn-primary '>Edit</a>   

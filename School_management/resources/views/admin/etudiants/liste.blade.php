                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="align-content: center"  >
                                        <div class="d-flex m-auto"  style="align-content: center; width: 250px;">
                                            <a href="{{route('adminEtudiant.edit',$Etudiant->id_etudiant."*".$data['grp'])}}" class="btn btn-primary col-4">Edit</a>

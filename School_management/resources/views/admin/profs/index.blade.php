        ...
        <div class="sidebar pe-4 pb-3 col-md-6 col-lg-6 col-sm-12">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('profs.index')}}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Teacher</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    @endif
                    <a href="{{ route('profs.create') }}" class='btn btn-primary col-6'> Add New Teacher </a><br><br>
                    <div class="table-responsive row ">
                        <table class='table table-striped'>
                            ...
                            <tr>
                                ...
                                <td class='text-white'>{{$Prof->Sexe}}</td>
                                <td class='text-white'>{{$Prof->Email}}</td>
                                <td class='text-white'>{{$Prof->Module}}</td>
                                <td class='text-white'>
                                    <div style="display: flex; width: 170px; column-gap: 10px;" class="container m-auto">

                                        <a href="{{ route('profs.edit', $Prof->id_prof) }}" class='btn btn-primary'>Edit</a>   

      ...
      <div class="sidebar pe-4 pb-3">
         <nav class="navbar bg-secondary navbar-dark">
               ...
               <div class="navbar-nav w-100">
                  ...
                  <a href="{{ route('Absences',$etudiant['id_etudiant']) }}" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Absence</a>
               ...
               <div class="bg-secondary text-center rounded p-4">
                  ...
                  <table class='table table-hover '>
                     ...
                     @foreach($Absences as $absence)
                        ...
                        <tr>
                           <th class="text-white" >{{$absence->created_at}}</th>
                           <th class="text-white" >{{$absence->module}}</th>
                           <th class="text-white">{{$absence->MasseHoraire}}</th>
                        </tr>  
                     @endforeach

        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('Exams') }}" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Exams</a>
                    <a href="{{ route('Absences',$etudiant['id_etudiant']) }}" class="nav-item nav-link "><i class="fa fa-chart-bar me-2"></i>Absence</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Message</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary  rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Message To Teacher</h6>
                    ...
                    <div class="table-responsive row">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect"
                                aria-label="Floating label select example" name='Prof'>
                                <option selected>Open this select menu</option>
                                @foreach($Prof as $Nom)
                                <option value="{{$Nom}}">{{$Nom}}</option>
                                @endforeach
                            </select>
                            <label for="floatingSelect">Choose teacher</label>
                        </div>
                        @endif
                        ...
                        <input class='btn btn-primary p-3 ' type='submit' value="Send" >

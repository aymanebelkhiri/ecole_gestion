                                ...
                                <tr>
                                    ...
                                    <td style="align-content: center">
                                        <div style="width: 100px" class="m-auto">
                                            ...
                                            <form action="{{ route('note.store2') }}" method="post" class="row" style="column-gap: 50px">
                                                @csrf
                                                <div class="col-3">
                                                    <input type="text" name="note" class="form-control" required style="width:70px;">
                                                </div>
                                    ...
                                    <td  style="align-content: center" colspan="3">
                                        <div style="width: 250px ;display: flex; column-gap: 50px;flex-wrap: wrap" class="m-auto container">
                                            @php
                                                $notes = Note::where(['Etudiant' => $Etudiant->id_etudiant, 'Module' => $prof->Module])->get();
                                            @endphp
                                        
                                            @foreach($notes as $note)
                                                    <a  href="{{route('note.edit',$note->id_note)}}" class="btn col-2 d-block">{{$note->Valeur}}</a>
                                            @endforeach

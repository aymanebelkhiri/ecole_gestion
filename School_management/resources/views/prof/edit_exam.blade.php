                    ...
                    <div class="table-responsive row ">
                        <form action="{{ route('exams.update',$exam['id_exam'])}}" method="POST" class="row">
                            ...
                            <div class="form-floating col-6 mb-3">
                                <select class="form-select" id="filiere" name="filiere" ria-label="Floating label select example" onchange="change(this.value)">
                            ...
                            <div class="col-md-6 mb-5 form-floating">
                            ...
                            <div class="col-md-6 form-floating">
                                ...
                                <label  class=" form-label"> &nbsp;&nbsp; Hour</label><br>

                            </div>
                            <div class="col-md-12">
                                <center>
                                    <button type="submit" class="btn btn-primary text-white col-3">Edit</button>
                                </center>
                            </div>
                        </form>
